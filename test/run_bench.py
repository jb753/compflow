...
if __name__ == '__main__':
    ...
    for Ni in N:
        ...
        # Timers
        T_fort = timeit.Timer(
            'cf.mcpTo_APo_from_Ma(Ma,ga)',
            'from __main__ import Ma,ga,cf'
            )
        T_native = timeit.Timer(
            'cf.native.mcpTo_APo_from_Ma(Ma,ga)',
            'from __main__ import Ma,ga,cf'
            )
    ...
    for Ni in N:
        ...
        T_native = timeit.Timer(
            'cf.native.Ma_from_mcpTo_APo(X,ga)',
            'from __main__ import X,ga,cf'
        )
    ...
    print('Lookup speedup: ', 1./speedup[(0,-1),])
